        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  (data.propertyCount ?? "0") + " Properties",
                                  style: TextStyle(
                                    fontFamily: "Rubik",
                                    fontSize: 9.5.sp,
                                    fontWeight: FontWeight.w400,
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 16.w),
                child: _buildFeaturedPropertiesSection(),
              ),

              Padding(
                padding: EdgeInsets.symmetric(horizontal: 16.w),
                child: SectionHeader(title: "Near You".tr, showSeeAll: false),
              ),
              ...
              VillaValuationCard(onGetEstimate: () {}),
