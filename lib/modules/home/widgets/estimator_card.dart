          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                stops: const [0.00, 0.38, 0.58, 0.78, 1.00],
                colors: [
                  Color(0xFFFFF9F9),
                  Color(0xFFFFF9F9),
                  Color(0xF5FFF9F9),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      final allowed = await GuestLimiter.canUseEstimator();

                      if (!allowed) {
                        AuthGuard.requireLogin(
                          message:
                              "You've reached the free estimation limit. Please login to continue.",
                        );
                        return;
                      }

                      Get.to(() => const PriceEstimatorScreen());
                    },
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Row(
                    children: [
                      Expanded(
                        child: _EstimateInfo(title: "Property", value: "Villa"),
                      ),
                      Expanded(
                        child: _EstimateInfo(title: "Area", value: "500 sqm"),
                      ),
                      Expanded(
                        child: _EstimateInfo(
                          title: "Location",
...
class _EstimateInfo extends StatelessWidget {
  ...
  const _EstimateInfo({required this.title, required this.value});
    ...
    return Column(
      ...
      children: [
        Text(
          title,
          maxLines: 1,
          style: TextStyle(fontSize: 4.8.sp, color: const Color(0xFF999999)),
        ),
